...
export class SportsComplexService {
    ...
    constructor(sportsComplexRepository: ISportsComplexRepository, addressRepository: IAddressRepository, validCnpjBusiness: ValidCnpjBusiness){
        this.sportsComplexRepository = sportsComplexRepository;
        this.addressRepository = addressRepository; 
        this.validCnpjBusiness = validCnpjBusiness;
    }

    addSportsComplex = async(newSportsComplex: NewSportsComplexWithAddress): Promise<SportsComplex> => {
        try{
